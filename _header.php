...
<html lang="en">
  <head>
    ...
    <title>Webbutveckling: Grundkurs (DA120A) - Malmö Högskola</title>
    <!-- Bootstrap core CSS -->
  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="/">DA120A: Webbutveckling</a>
        </div>
    ...
    <div class="container">
		<div class="row pageTitle">
			<div class="col-lg-8">
				<h1>Webbutveckling: Grundkurs (DA120A)</h1>
			</div>
			<div class="col-lg-4">
