...
<p>Formuläret ska sedan skickas (när man klickar på knappen "skicka") till följande adress: "http://dist1.webbintro.se/resources/response.php" med metoden "GET". Den sidan kommer att tolka den data som ni skickar, och skiva ut den, så att ni kan se att ert formulär skickar iväg korrekt data. Exempel på hur det kan se ut när man skickat iväg sitt formulär:</p>
...
<h4>3.1. Tips</h4>
<ul>
    <li><a href="http://www.w3schools.com/tags/att_input_type.asp">Här kan ni hitta en lista på olika typer av text-fält</a>
    </li>
    <li><a href="http://www.w3schools.com/tags/att_input_required.asp">För att ett fält <b>måste</b> fyllas i innan formuläret skickas</a>
    </li>
    <li><a href="http://www.w3schools.com/tags/att_input_placeholder.asp">En bekrivning av text-fält</a>
    </li>
...
<ul>
    ...
    <li>Varje sektion i formuläret ska vara ett <code>&lt;fieldset&gt;</code> med tillhörande <code>&lt;legend&gt;</code>
    </li>
    ...
    <li>Formuläret ska skicka till följande adress "http://dist1.webbintro.se/resources/response.php" med metoden "GET" (när man klickar på knappen "skicka".</li>
