<div class="row">
	<div class="col-lg-8">
        ...
        <p>Uppgiften går ut på att ni ska skapa en sida som följer denna mall (den behöver inte ha Star Wars-tema, men eftersom det nyligen var <a href="http://en.wikipedia.org/wiki/Star_Wars_Day" target="_blank">den 4:e maj</a> blev det mitt tema):</p>
        ...
        <h4>Innehåll på webbsidan ska alltså vara följande</h4>
        <h5>Om man surfar in genom en dator</h5>
        <ul>
            <li>En vänsterkolumn
                <ul>    
                    <li>Logotyp</li>
        ...
        <h5>Om man surfar in med en mobil</h5>
        <ul>
