...
?>
	<div class="row">
		<div class="col-lg-8">
			<h2>Distanskurs på Malmö Högskola</h2>
			<p>Välkomna till denna webbplats som i första hand riktar sig till de studenter som läser kursen Webbutveckling: Grundkurs (DA120A) på Malmö Högskola. Här hittar ni information & material kring kursen som t.ex. planering, föreläsningsmaterial, övningar, inlämningsuppgifter m.m. Webbplatsen är även öppen även för andra besökare som vill ta del av kursens material.</p>
			<p>Allt material på webbplatsen är publicerat under en <a href="http://creativecommons.org/licenses/by/4.0/deed.sv">fri licens</a>, vilket gör att det kan återanvändas av andra, så länge upphovsman anges.</p>
			<p>För de studenter som tillhör kursen är de viktigt att notera att två kursplatser används, denna webbplats och Malmö Högskolas system <a href="http://mah.se/lms">It's Learning</a>.</p>
			<h3>It's Learning</h3>
			<p>Its Learning hanterar det administrativa för kursen, till exempel:</p>
			<ul>
