<h2>Laboration - CSS i externt dokument</h2>
...
<p>Börja med att spara hem detta <a href="/exercises/5/External-CSS/page.html">HTML-dokument</a> (högerklicka, välj &#8220;Spara som&#8221; eller motsvarande, alternativt kopiera källkoden). Studera hur detta dokument är uppbyggt - HTML-strukturen är viktigt för hur CSS-reglerna ska utformas.</p>

<p>När du öppnar dokumentet i en webbläsare så kommer du finna att det inte är så visuellt tilltalande. Detta kan avhjälpas med stilmall skriven i CSS! Genom en sådan stilmall kan webbläsarens standardvärde för presentation överskrivas och eget utseende definieras. Först krävs en plats att skriva CSS på - detta kan göras med elementet <code>style</code>, som infogas inom <code>&lt;head&gt;</code>-elementet:</p>
...
<p><img src="/exercises/5/External-CSS/result.png" alt="" width="100%" /></p>

<p><strong>Exempellösning</strong> på övningen kan du hitta <a href="/exercises/5/External-CSS/facit.zip">här</a>.</p>
