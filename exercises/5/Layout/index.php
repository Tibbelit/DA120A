...
<p>
    <figure>
        <img src="/exercises/5/Layout/goal.png" alt="Centrerad webbsida med sidhuvud överst, menykolumn till vänster och innehållskolumn till höger">
    </figure>
</p>
...
<p>I detta skede kan det se ut såhär:
    <img src="/exercises/5/Layout/1.png" alt="Fyra horisontella, olikfärgade fält">
</p>
...
<p>I detta skede bör du ha en centrerad layout, som ser ut ungefär såhär:
    <img src="/exercises/5/Layout/2.png" alt="Sidhuvud överst, menykolumn till vänster och innehållskolumn till höger">
</p>
...
<p>Därefter kan det se ut ungefär såhär:
    <img src="/exercises/5/Layout/layout.png" alt="">
</p>
...
<p>Dokumentet kan sedan - till exempel - se ut såhär:
    <img src="/exercises/5/Layout/finished.png" alt="">
</p>
...
<p>Som alltid, se till att dokumentet <a href="http://validator.w3.org/">validerar</a>. Använd <a href="http://jigsaw.w3.org/css-validator/">CSS-validatorn</a> för alla stilmallar.</p>

<p><strong>Exempellösning</strong> hittar ni <a href="/exercises/5/Layout/facit.zip">här</a>.</p>
