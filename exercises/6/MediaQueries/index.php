<h2>Övning: Media Queries</h2>
<p>CSS 3 Media Queries en viktig teknik, och möjliggörande för det som kallas Responsive Web Design. Denna laboration går ut på att tillämpa media queries för att förbättra upplevelsen för mindre respektive större skärmar. Det är en god idé att läsa lite om responsive design innan eller i samband med laborationen.</p>

<h3>1. Basfallet</h3>
<p>I detta fall finns en färdig webbsida, som ser okej ut i &quot;mellanstora&quot; webbläsare. <strong><a href="/exercises/6/MediaQueries/page.html">Kika på den här</a></strong>.</p>
...
<p>Använd nu en av dina tidigare layouter - och mobilanpassa denna efter eget tycke och smak. Tänk på att försöka att ha användbarhet och tillgänglighet i fokus! =)</p>
